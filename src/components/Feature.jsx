...
const Feature = () => {
  ...
  return (
    <div className="conatiner h-auto py-5 mt-10 font-poppins dark:bg-dark" >

          <div className="text-center dark:text-white mb-6">
                <h2 className="text-vm-title sm:text-sm-title md:text-md-desc lg:text-lg-title xl:text-xl-title font-bold">{t('konten-fitur.judul')}</h2>


            <p className="text-vm-desc sm:text-sm-desc md:text-md-desc lg:text-lg-desc xl:text-xl-desc font-medium">{t('konten-fitur.Deskripsi1')} <br></br> {t('konten-fitur.Deskripsi2')}</p>
          </div>



          <div className="vm:px-vm sm:px-sm lg:px-lg xl:px-xl grid grid-cols-1 gap-[20px] lg:grid-cols-3">
              ...
              <div className="shadow-custom-dark w-full h-auto bg-white p-4 rounded-[20px] dark:border-gray dark:border-2 dark:bg-dark">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-buildings" viewBox="0 0 16 16">
                ...
                <h2 className="text-vm-title sm:text-sm-title md:text-md-desc lg:text-lg-title xl:text-xl-title font-bold mt-vm sm:mt-sm md:mt-md lg:mt-lg xl:mt-xl dark:text-white">{t("konten-fitur.Judul-Layanan-Public1")} <br></br>{t("konten-fitur.Judul-Layanan-Public2")}</h2>
              ...
              <div className="shadow-custom-dark  w-full h-auto bg-white p-4 rounded-[20px]  dark:border-gray dark:border-2 dark:bg-dark">
                ...
                <h2 className="text-vm-title sm:text-sm-title md:text-md-desc lg:text-lg-title xl:text-xl-title font-bold mt-vm sm:mt-sm md:mt-md lg:mt-lg xl:mt-xl dark:text-white ">{t("konten-fitur.Judul-Kota-Iot1")}  <br></br>{t("konten-fitur.Judul-Kota-Iot2")}</h2>
              ...
              <div className="shadow-custom-dark  w-full h-auto bg-white p-4 rounded-[20px]  dark:border-gray dark:border-2 dark:bg-dark">
                ...
                <h2 className=" text-vm-title sm:text-sm-title md:text-md-desc lg:text-lg-title xl:text-xl-title font-bold mt-vm sm:mt-sm md:mt-md lg:mt-lg xl:mt-xl dark:text-white">{t("konten-fitur.Judul-Menerapkan-Smart1")} <br></br>{t("konten-fitur.Judul-Menerapkan-Smart2")}</h2>
