  ...
  return (
    <div className="conatiner h-auto py-5 mt-10 font-poppins dark:bg-dark" >
          ...
          <div className="text-center dark:text-white mb-6">
                <h2 className="text-2xl font-bold lg:text-3xl">{t('konten-fitur.judul')}</h2>
            <p className="text-[12px] mt-2 lg:text-xl">{t('konten-fitur.Deskripsi1')} <br></br> {t('konten-fitur.Deskripsi2')}</p>
          </div>
          ...
          <div className="vm:px-vm sm:px-sm lg:px-lg xl:px-xl grid grid-cols-1 gap-[20px] lg:grid-cols-3">
              ...
              <div className="shadow-custom-dark w-full h-auto bg-white p-4 rounded-[20px] dark:border-gray dark:border-2 dark:bg-dark">
                ...
                <h2 className=" text-2xl font-bold mt-4  lg:text-2xl dark:text-white">{t("konten-fitur.Judul-Layanan-Public1")} <br></br>{t("konten-fitur.Judul-Layanan-Public2")}</h2>
              ...
              <div className="shadow-custom-dark  w-full h-auto bg-white p-4 rounded-[20px]  dark:border-gray dark:border-2 dark:bg-dark">
                ...
                <h2 className=" text-2xl font-bold mt-4   lg:text-2xl   dark:text-white">{t("konten-fitur.Judul-Kota-Iot1")}  <br></br>{t("konten-fitur.Judul-Kota-Iot2")}</h2>
              ...
              <div className="shadow-custom-dark  w-full h-auto bg-white p-4 rounded-[20px]  dark:border-gray dark:border-2 dark:bg-dark">
                ...
                <h2 className=" text-2xl font-bold  mt-4 lg:text-2xl  dark:text-white">{t("konten-fitur.Judul-Menerapkan-Smart1")} <br></br>{t("konten-fitur.Judul-Menerapkan-Smart2")}</h2>
